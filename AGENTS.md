...
- Do not patch, compile, or treat `/mnt/ceph/dever_for_dev/third_party/vscode` as a source tree for either service. That location only retains the Dever-side service control scripts during the migration.
