...
export const EditorPartModalFullscreenContext = new RawContextKey<boolean>('editorPartModalFullscreen', false, localize('editorPartModalFullscreen', "Whether the modal editor part covers the complete workbench"));
